        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              {/* Special message requested by user */}
              ...
              <motion.button
                ...
                type="button"
                onClick={onProceed}
                className="group relative mt-2 flex items-center justify-center gap-2 rounded-full border border-gold bg-gradient-to-r from-[#92400e] via-[#b45309] to-[#92400e] px-8 py-3 text-xs font-semibold uppercase tracking-[0.25em] text-[#fef3c7] shadow-lg transition-all"
              >
